...
public class Frepattern_MB { 
	  public static void main(String[] args) { 
	      ...
	      HSSFSheet sheet=wb.createSheet("Frepattern_MB"); 
			try{
				readFile="../Sample data/Frepattern_MB.txt";
				...
				trace="../Sample data/MapInformationMB.txt";
			...
			//输出Excel文件  
			try{
			FileOutputStream output=new FileOutputStream("../Sample data/Frepattern_MB.xls");  
			wb.write(output);  
			output.flush();
			wb.close();}	  
			catch(IOException e){
